...
@gacutil /if bin\Release\SampleMimeEncoding.dll
@BTSTask AddApp -ApplicationName:MimeSampleApplication
@BTSTask AddResource -ApplicationName:MimeSampleApplication -Type:System.BizTalk:BizTalkAssembly -Source:bin\Release\SampleMimeEncoding.dll
